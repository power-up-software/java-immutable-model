...
/**
 * A <code>LongGreaterThanEqualToValidator</code> is a validator that validates if a parameter is greater than or equal to the provided value.
 *
 * @author Chris Picard
 */
@SuppressWarnings("JavadocReference")
public final class LongGreaterThanEqualToBuilderValidator extends BuilderValidatorAbs {
    /**
     * The supplier of the long parameter to validate that it is greater than or equal to the min value.
     */
     ...
     */
    public LongGreaterThanEqualToBuilderValidator(final String name, final Supplier<Long> valueSupplier, final long minValue) {
        super(name);
        validateBuilder();
