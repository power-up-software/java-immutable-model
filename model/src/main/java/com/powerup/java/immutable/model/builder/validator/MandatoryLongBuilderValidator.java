...
/**
 * A <code>MandatoryLongValidator</code> is a validator that validates if a mandatory long is set. In this context set mean not null and not equal to
 * 0.
 *
 * @author Chris Picard
 */
@SuppressWarnings("JavadocReference")
public final class MandatoryLongBuilderValidator extends BuilderValidatorAbs {
    /**
     * The supplier of the long parameter to validate that it is set.
     */
     ...
     */
    public MandatoryLongBuilderValidator(final String name, final Supplier<Long> valueSupplier) {
        super(name);
        validateBuilder();
